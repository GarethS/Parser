...
typedef enum {nodeVar, nodeConst, nodeOperator, nodeArray, nodeInvalid, nodeStartAction, nodeTemporary, nodeIf, nodeFloat, nodeMotorMove, nodeMotorGetPosition} nodeType;
